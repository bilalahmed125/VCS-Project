...
int choose(){
    ...
    cout<<"\n\t\033[31m7-Delete File Version.\033[0m"<<endl;
	cout<<"\n\t\033[33m8-Exit.\033[0m"<<endl;
	cout<<"\n\033[33mEnter your choice(1-8): \033[0m";
	cin>>ch;
	cin.ignore();
	return ch;
}
    ...
    while(true){
        ...
        if(!test){
            ...
            if(reenterchoice == 'y'|| reenterchoice == 'Y'){
                ...
                system("cls");
                cout<<"\n\t\t\033[32mYouve Selected NOT TO RE-ENTER.... EXITING FILE READING MENU!...";
                cout<<"\n\t";
                system("pause");
                cout<<"\033[0m";
                return;
